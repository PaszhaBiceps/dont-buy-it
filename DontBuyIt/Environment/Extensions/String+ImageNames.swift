...
extension String {
    static let grayDotIcon = "gray_dot_icon"
    static let greenDotIcon = "green_dot_icon"
    static let redDotIcon = "red_dot_icon"
    static let placeholder = "placeholder"
    static let smallGreenInfoIcon = "small_green_info_icon"
